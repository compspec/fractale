...
debug_task = """Please identify the error and advise for how to fix it. The agent you are returning to can only make scoped changes, which we provide below. If you determine the issue cannot be resolved by changing one of these files, we will need to return to another agent. In this case, please provide "RETURN TO MANAGER" anywhere in your response.
