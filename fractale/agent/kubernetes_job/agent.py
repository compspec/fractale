...
class KubernetesJobAgent(GeminiAgent):
    ...
    def get_diagnostics(self, job, pod):
        ...
        # Get job and pod events
        return prompts.meta_bundle % (job_description, pods_description, events_description)
